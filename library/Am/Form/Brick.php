...
class Am_Form_Brick_Occupation extends Am_Form_Brick
{
    ...
    public function __construct($id = null, $config = null)
    {
        $this->name = ___('Occupation Information');
    ...
    public function insertBrick(HTML_QuickForm2_Container $form)
    {
        $fieldSet = $this->getConfig('hide_fieldset') ?
          $form :
          $form->addElement('fieldset', 'occupation', array('id' => 'row-occupation-0'))->setLabel($this->___('Occupation Information'));
