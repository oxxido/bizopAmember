...
class Am_Mail_TemplateTypes extends ArrayObject
{
    ...
    static function createInstance()
    {
        ...
        $o->exchangeArray(array_merge(array(
            ...
            array(
                'id' => 'productwelcome',
                'title' => 'Product Welcome E-mail',
                'mailPeriodic' => Am_Mail::REGULAR,
                'vars' => array('user', 'invoice', 'payment', 'last_product_title' => 'Product Title of the Latest Purchased Product'),
            ),
            'expire' => 
            array(
                'id' => 'expire',
