...
class AdminImportOss6Controller extends Am_Controller
{
    ...
    function indexAction()
    {
        ...
        if ($importer->run($done) === true)
        {
            ...
            $this->view->content .= "<br /><br/><a href='" . REL_ROOT_URL . "/admin-import-oss6'>Continue to import other information</a>";
        ...
        {
            $this->redirectHtml(REL_ROOT_URL . "/admin-import-oss6?done=$done&i=$import", "$done records imported");
        }
    }
